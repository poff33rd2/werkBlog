...
reducing bounce rate by 19%.

• Applied WCAG standards and on-page SEO, boosting performance, usability, and local
keyword rankings (+2 positions in 4 months).

• Designed landing pages that drove 4–5 new rental leads in 14 days and increased
booking conversions by 15%.

• Automated client communication workflows, saving ~8 minutes per booking and
improving retention.

• Built a custom Facebook GraphQL upload-to-post pipeline and scheduled
communication jobs for engagement.

• Conducted DSUs and user testing to refine sales funnels, journey flows, and uncover
new opportunities.
